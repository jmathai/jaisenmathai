          ...
          <div class="details">
            <ul>
              <xsl:for-each select="details/detail">
                <li>
                  <xsl:copy-of select="./screenshot/img" />
                  <p><xsl:value-of select="./@description" /> (<xsl:value-of select="./skills" />)</p>
                </li>
              </xsl:for-each>
            </ul>
          </div>
        ...
        <div>
          <ul>
            <xsl:for-each select="/resume/educations/education">
              <li>
                <ul>
                  <li><strong><xsl:value-of select="name" /> (<xsl:value-of select="dates" />)</strong></li>
                  <li><xsl:value-of select="major" /></li>
                </ul>          
              </li>
            </xsl:for-each>
          </ul>
